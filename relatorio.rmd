...
A análise do modelo selecionado é realizada através do gráficos da série de resíduos sem zeros na inicialização, de normalidade e do ACF.

Pelo primeiro gráfico acima nota-se a presença de ruído branco, pois os pontos não fogem de 0, com variação constante ao longo do tempo. Pelo  ACF constata-se que a série não possui autocorrelações siginificativas , pois as autocorrelações dos lags variam dentro do intervalo de confiança. 

A interpretação  dos gráficos pode ser confirmada pelos testes estatísticos. Assim, considerando um nível de significância de 0,05, os testes de Shapiro Wilk, Box e KPS apresentaram p valor de 0,7139, 0,9389 e 0.1 respectivamente, de forma que não há evidências para rejeitar a hipotése nula. Conclui-se que a a série é estacionária, apresenta normalidade e é independente.
